                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        className={`relative ${color} w-9/12 flex flex-col items-center rounded-md ${color === "bg-cyan"
                          ? "hover:bg-hovered-cyan"
                          : "hover:bg-hovered-soft-red"
                          } hover:cursor-pointer transition ease-in-out duration-500`}
                      >
                        <div
                          className={`absolute flex bg-dark-brown transition ease-in duration-100  -top-12 w-20 h-10 justify-center items-center text-center mb-52 text-lg z-50 ${index !== hovered && `opacity-0`
